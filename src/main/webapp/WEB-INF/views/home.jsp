...
<body>
	...
	<header>
		<ul>
			<li><a class="links" href="https://myaccount.google.com/"><button
						class="signbutton" type="button">Sign in</button></a></li>
	...
	<form action="search" method="get">
		...
		<div class="bar">
			<input class="searchbar" type="text" title="Search" name="querybox"
				autofocus="autofocus">
		</div>
		<div class="buttons">
